...
class QuantityAdderCart extends StatefulWidget {
  final String productId;
  final String price;
  final String qty;
  QuantityAdderCart({required this.productId,required this.price,required this.qty});

  @override
  State<QuantityAdderCart> createState() => _QuantityAdderCartState();
}

class _QuantityAdderCartState extends State<QuantityAdderCart> {


  int x =0;
  String msg1 = '';
  void initState() {
    x = int.parse(widget.qty);
    super.initState();
  }
  ...
  // final SnackBar _snackBar = SnackBar(content: Text('Products added to cart'));
